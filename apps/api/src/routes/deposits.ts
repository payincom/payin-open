 ...
 */
deposits.get('/references', authMiddleware(), requirePermission('deposits:read'), async c => {
  try {
    const manager = getManager();
 ...
 * Required permission: deposits:read
 */
deposits.get('/stats', authMiddleware(), requirePermission('deposits:read'), async c => {
  try {
    const manager = getManager();
 ...
 * Required permission: deposits:read
 */
deposits.get('/', authMiddleware(), requirePermission('deposits:read'), async c => {
  try {
    const manager = getManager();
