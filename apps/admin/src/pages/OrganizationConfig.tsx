/**
 * OrganizationConfig Page
 * Organization owner/admin page for managing organization-level configuration
 */
    ...
    <div className="p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h1 className="text-3xl font-bold">Organization Configuration</h1>
          </div>
          <p className="text-muted-foreground">
            Manage configuration for <span className="font-semibold">{organization?.name}</span>.
      ...
      {!isLoading && (
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium">Organization Overrides</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{orgConfigs.length}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{usingGlobal}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{usingDefaults}</div>
