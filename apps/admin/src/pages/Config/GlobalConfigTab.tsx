/**
 * GlobalConfigTab Component
 * Super admin tab for managing global configuration values
 */
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-2xl font-bold text-foreground">Global Configuration</h2>
          </div>
