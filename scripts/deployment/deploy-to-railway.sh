...
echo "  Config: railway.$([ "$ENVIRONMENT" = "production" ] && echo "production" || echo "test").api.toml"
echo "============================================================"
echo ""
...
if [ "$ENVIRONMENT" = "production" ]; then
    export RAILWAY_CONFIG_FILE="railway.production.api.toml"
    echo "   Using config: railway.production.api.toml"
else
    export RAILWAY_CONFIG_FILE="railway.test.api.toml"
    echo "   Using config: railway.test.api.toml"
fi
echo ""
...
echo "     curl https://<your-api-domain>/health"
echo ""
