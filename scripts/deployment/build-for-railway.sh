...
echo "     - Using CLI: railway up --service payin-api --environment test"
echo "     - Or trigger via Railway Dashboard"
echo ""
echo "💡 Tip: Make sure Railway environment variables are configured"
echo "    See: docs/self-hosting/configuration.md; run npm run open:init -- --check before npm run open:init"
echo ""
