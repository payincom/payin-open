 ...
 *
 * PayIn Open uses one fixed merchant-organization payment scope. PayIn Cloud maps
 * this scope to an explicit tenant/organization. The current persistence layer still
...
/** Stable internal payment scope used by the built-in PayIn Open runtime. */
