...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| Payment order core                | `packages/processor/src/services/order-service.ts`, `packages/manager/src/manager.ts`, `apps/api/src/routes/orders.ts`                                  | Present, mostly same code, with Open default org resolution in API and Open facades       | Good shared Open core candidate, but tenant id is still threaded through service/repository signatures.             |
...
| `apps/api/src/open-runtime.ts`                                                                            | Transitional Open compatibility                                  | Provides runtime guard/default org resolution.                                                                      | Helpful for Phase 1, but not enough as a formal plugin/overlay API.                        |
